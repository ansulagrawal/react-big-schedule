...
/**
 * Render the main Scheduler component: a configurable, responsive calendar view with optional resource column and drag-and-drop support.
 *
 * @param {object} props - Component properties.
 * @param {SchedulerData} props.schedulerData - Scheduler state and configuration helper used to derive views, sizes, and behaviors.
 * @param {Array<DnDSource>} [props.dndSources] - Additional drag-and-drop sources to merge with the default event source.
 * @param {React.RefObject<HTMLElement>} [props.parentRef] - Reference to a parent element whose size drives responsive layout when enabled.
 * @param {function} props.prevClick - Callback invoked to navigate to the previous date range (receives schedulerData).
 * @param {function} props.nextClick - Callback invoked to navigate to the next date range (receives schedulerData).
 * @param {function} props.onViewChange - Callback invoked when the view changes (receives schedulerData and an object {viewType, showAgenda, isEventPerspective}).
 * @param {function} props.onSelectDate - Callback invoked when a date is selected (receives schedulerData and the selected date).
 * @param {React.ReactNode} [props.leftCustomHeader] - Optional custom element rendered in the left side of the header.
 * @param {React.ReactNode} [props.rightCustomHeader] - Optional custom element rendered in the right side of the header.
 * @returns {JSX.Element} The scheduler table element containing the header and either the agenda view or the resource/time grid.
 */
